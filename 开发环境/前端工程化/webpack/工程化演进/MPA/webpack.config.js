...
module.exports = {
  ...
  output: {
    ...
    filename: 'js/[name].[contentcontenthash:8].bundle.js'
  },
  devServer: {
    static: {
  ...
  module: {
    rules: [{
      ...
      generator: {
        filename: 'images/[name].[contentcontenthash:8][ext]',
      },
    }]
  },
  plugins: [
    ...
    new MiniCssExtractPlugin({
      filename: 'css/[name].[contentcontenthash:8].css',
      chunkFilename: 'css/[name].chunk.[contentcontenthash:8].css'
    }),
