<template>
  <div>
    ...
    <div class="thImg">
      <div class="clearfix">
        <a href="vase_proList.html"><img src="./images/i1.jpg" /></a>
        <a href="proList.html"><img src="./images/i2.jpg" /></a>
        <a href="#2"><img src="./images/i3.jpg" /></a>
      </div>
    </div>
    <!---news--->
    <div class="news">
      <div class="wrapper">
        <h2><img src="./images/ih1.jpg" /></h2>
    ...
    <!---ad--->
    <a href="#" class="ad"><img src="./images/ib1.jpg" /></a>
    <!---people--->
    <div class="people">
      <div class="wrapper">
        <h2><img src="./images/ih3.jpg" /></h2>
    ...
    <div class="gotop">
      <a href="cart.html">
        <dl>
          <dt><img src="./images/gt1.png" /></dt>
          <dd>去购<br />物车</dd>
        </dl>
      </a>
      <a href="#" class="dh">
        <dl>
          <dt><img src="./images/gt2.png" /></dt>
          <dd>联系<br />客服</dd>
        </dl>
      </a>
      <a href="mygxin.html">
