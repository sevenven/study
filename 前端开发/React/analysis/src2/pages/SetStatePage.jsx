	...
	render() {
		...
		return (
			<div>
				...
				<button onClick={this.changeCountWithCallback}>change count 合成事件 asas with callback</button>

				<button onClick={this.changeCountWithSetTimeout}>合成事件 setTimeout clidck</button>
